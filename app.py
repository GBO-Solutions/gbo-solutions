...
with col1:
  ...
  if not st.session_state['show_simplex_text']: #*#
    ...
    st.markdown('''
        <div style='height: 720px; overflow-y: auto; background-color: #fff0f0; padding: 1rem; border: 1px solid #ccc; border-radius: 8px; text-align: justify; color: red; font-size: 16px;'>
